...
public class ModifyStu {
		  ...
		  List stuInfo = null;
		  public ModifyStu(JFrame frame_main,StudentRollInfo stu, SocketHelper sockethelper)
		  {
		  ...
		  private void initialize(StudentRollInfo stu)
		  {
		    ...
		    this.jb_ConfirmAdd = new JButton("\u786E\u8BA4\u4FEE\u6539");
		    ...
		    {
		      public void actionPerformed(ActionEvent e) {
		        String sId = ModifyStu.this.textField_sID.getText();
		        String sAge = ModifyStu.this.textField_sAge.getText();
		        String sBirthdate = ModifyStu.this.textField_sBirthdate.getText();
		        String sName = ModifyStu.this.textField_sName.getText();
		        String sSex = ModifyStu.this.textField_sSex.getText();
		        String sPlace = ModifyStu.this.textField_sPlace.getText();
		        String sDepart = ModifyStu.this.textField_sDepart.getText();
		        String sDormitory = ModifyStu.this.textField_sDormitory.getText();
		        if ((sId.length() != 0) && (sName.length() != 0) && 
		          ...
		          boolean isSave = new IStudentImpl(ModifyStu.this.sockethelper).ModifyStu(s);
		  ...
		  protected void showStuInfo(StudentRollInfo stu){
			  System.out.println("showstuInfo");
			  this.textField_sID.setText( stu.getId());
			  this.textField_sID.setEditable(false);
			  this.textField_sName.setText(stu.getName());
			  this.textField_sAge.setText(stu.getAge());
			  this.textField_sSex.setText(stu.getGender());
			  this.textField_sBirthdate.setText(stu.getBirthday());
			  this.textField_sPlace.setText( stu.getBirthPlace());
			  this.textField_sDepart.setText(stu.getDepartment());
			  this.textField_sDormitory.setText(stu.getDormitory());
